...
def send_confirmation_email(email, code):
    activation_url = f'http://13.50.5.59/api/v1/customer/activate/?u={code}'
...
def reset_password(email):
    ...
    reset_link = f'http://13.50.5.59/api/v1/customer/reset/new/password/?make_sure={sure}'

    html_message = format_html('''
        <!DOCTYPE html>
        <html>
        <head>
            <title>Вастанавление пароля</title>
        </head>
        <body>
            <p>Здравствуйте!</p>
